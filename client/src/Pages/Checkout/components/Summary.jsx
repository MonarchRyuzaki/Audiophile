...
const Summary = () => {
  ...
  const total = parseInt(JSON.parse(localStorage.getItem("totalPrice")));
  ...
  return (
    <div>
      ...
      <div className="flex justify-between mt-6">
        ...
        <div className="font-bold text-lg text-orange">${vat + total + 50}</div>
      </div>
      <button className="bg-orange w-full mt-3 uppercase text-primary tracking-wide font-semibold text-md py-3 ">
        Continue and pay
      </button>
    </div>
  );
